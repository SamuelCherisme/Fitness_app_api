...
class FitnessesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fitness" do
    assert_difference('Fitness.count') do
      post fitnesses_url, params: { fitness: { description: @fitness.description, name: @fitness.name } }, as: :json
    end
  ...
  test "should update fitness" do
    patch fitness_url(@fitness), params: { fitness: { description: @fitness.description, name: @fitness.name } }, as: :json
    assert_response 200
  end
